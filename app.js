...
var taskInput=document.querySelector("input[type=text]");//Add a new task.
...
var createNewTaskElement=function(taskString){
    ...
    label.className="task__item__label";
    listItem.className ="task__item";
    

    //Each elements, needs appending
    checkBox.type="checkbox";
    checkBox.className="task__item__input";
    editInput.type="text";
    editInput.className="task__item__input_text";
    ...
    deleteButtonImg.classList.add("task__item__img");
